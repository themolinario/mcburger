...
const removeUserById = async (id) => {
  return DAO.Mongo.Models.User.findByIdAndDelete(id);
}

const countUsersByUsername = async (username = '') => {
  return DAO.Mongo.Models.User.countDocuments({ title: { $regex: '.*' + title + '.*' } });
};
